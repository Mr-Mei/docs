import{_ as n,o as s,c as a,e as t}from"./app-59688067.js";const p="/docs/images/CSS/线性渐变.jpg",e="/docs/images/CSS/边框渐变.jpg",c="/docs/images/CSS/contain.jpg",i="/docs/images/CSS/cover.jpg",l="/docs/images/CSS/百分比.jpg",o="/docs/images/CSS/三角形.jpg",u="/docs/images/CSS/下三角形.jpg",r="/docs/images/CSS/凸弧形.jpg",d="/docs/images/CSS/凹弧形.jpg",k={},v=t(`<h1 id="css常用技巧" tabindex="-1"><a class="header-anchor" href="#css常用技巧" aria-hidden="true">#</a> CSS常用技巧</h1><h2 id="_1-文字溢出省略号" tabindex="-1"><a class="header-anchor" href="#_1-文字溢出省略号" aria-hidden="true">#</a> <strong>1. 文字溢出省略号</strong></h2><p><strong>单行文字</strong>溢出：</p><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token property">overflow</span><span class="token punctuation">:</span> hidden<span class="token punctuation">;</span>            // 溢出隐藏
